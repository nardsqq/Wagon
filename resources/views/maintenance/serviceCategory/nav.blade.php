...
<div class="panel-group" id="accordion">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <a href="{{ url('/admin/maintenance/servicecategory') }}" class="list-group-item active main-color-bg"><i class="fa fa-thumbs-o-up fa-fw" aria-hidden="true"></i>&nbsp; Service Category</a>
