var app = new Vue({
    ...
    methods: {
        ...
        // },
        selectVariant: function(variant, event){
            return !this.isSelected(variant.int_var_id) ? (variant.action = 'Withdraw', variant.quantity = 1, this.selected_variants.push(variant)) : this.selected_variants = _.remove(this.selected_variants, function(v){
