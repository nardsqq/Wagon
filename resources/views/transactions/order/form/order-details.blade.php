...
<div class="col-xs-12  m-t-10">
    ...
    <div>
        <label>
            {!! Form::radio('delivery_type', 0, true, ['v-model'=>'delivery_option', ':disabled'=>'order_type==1']); !!}
            Delivery
        </label>
        
        <label>
            {!! Form::radio('delivery_type', 1, false, ['v-model'=>'delivery_option', ':disabled'=>'order_type==1']); !!}
            Pick-up
        </label>
    </div>
</div>
