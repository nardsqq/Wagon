...
@section('content')
 ...
 <header id="header">
  ...
  @include('maintenance.delivery-charge.modal')
          ...
          <div class="panel panel-default">
            <div class="panel-heading clearfix">
              <div class="btn-group pull-right">
                <button type="button" id="btn-add" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp; Add Delivery Charge</button>
              </div>
            ...
            <div class="panel-body">
              <div id="table-container">
                @include('maintenance.delivery-charge.table')
              </div>
            </div>
          </div>
        </div>
