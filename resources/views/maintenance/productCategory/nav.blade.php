...
<div class="panel-group" id="accordion">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <a href="{{ url('/admin/maintenance/productcategory') }}" class="list-group-item active main-color-bg"><i class="fa fa-cart-arrow-down fa-fw" aria-hidden="true"></i>&nbsp; Product Category</a>
