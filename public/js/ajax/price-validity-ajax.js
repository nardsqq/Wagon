$(document).ready(function() {
  ...
  $(document).on('click', '.open-modal', function() {
    ...
    $('#price-validity-modal-header').addClass('modal-header-info').removeClass('modal-header-success');
  ...
  $('#btn-add').on('click', function(event) {
    ...
    $('#price-validity-modal-header').addClass('modal-header-success').removeClass('modal-header-info');
    $('#formPriceVal').trigger("reset");
  ...
  $("#btn-save").on('click', function (e) {
    ...
    var formData = $("#formPriceVal").serialize();
  ...
  $.ajax({
      ...
      var row = $("<tr id=id" + data.intPriceValID +  "></tr>")
      .append(
          "<td>" + data.strPriceVName + "</td>" +
          "<td>" + data.strPriceVDuration + "</td>" +
          "<td class='text-center'>" +
          "<button class='btn btn-info btn-sm btn-detail open-modal' value="+data.intPriceValID+"><i class='fa fa-edit'></i>&nbsp; Edit</button> " +
          "<button class='btn btn-danger btn-sm btn-delete' value="+data.intPriceValID+"><i class='fa fa-trash-o'></i>&nbsp; Delete</button>" +
          "</td>"
      );
      ...
      if (state == "add") { 
        ...
        toastr.success("Successfully Added a New Vehicle Type Record");
          ...
          table.row($("#id"+data.intPriceValID)).remove();
          table.row.add(row).draw();
      }
