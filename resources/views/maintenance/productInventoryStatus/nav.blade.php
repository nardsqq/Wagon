...
<div class="panel-group" id="accordion">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <a href="{{ url('/admin/maintenance/product') }}" class="list-group-item"><i class="fa fa-cart-plus fa-fw" aria-hidden="true"></i>&nbsp; Product</a>
      <a href="{{ url('/admin/maintenance/productinventorystatus') }}" class="list-group-item active main-color-bg"><i class="fa fa-pie-chart fa-fw" aria-hidden="true"></i>&nbsp; Product Inventory Status</a>
