          ...
          <div class="list-group">
            ...
            <a href="{{ url('/admin/transactions/deliveryschedule') }}" class="list-group-item active main-color-bg"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>&nbsp; Set Delivery Schedule</a>
