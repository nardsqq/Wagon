...
<div class="col-xs-12  m-t-10">
    ...
    {{ Form::text('contact_no', null, ['class'=>'form-control',':value'=>'selected_client.str_client_mobile_num']) }}
</div>
...
<div v-if="existing_client == 1">
    ...
    <div class="col-xs-6  m-t-10">
        ...
        {!! Form::text('str_client_tel_num', null, ['id' => 'str_client_tel_num', 'class' => 'form-control', ':value'=>'selected_client.str_client_tel_num']) !!}
    </div>
    <div class="col-xs-12 m-t-10">
        {!! Form::label('str_client_email', 'Email Address', ['required'=>'required']) !!}
        {!! Form::text('str_client_email', null, ['id' => 'str_client_email', 'class' => 'form-control', ':value'=>'selected_client.str_client_email']) !!}
    </div>
    <div class="col-xs-6  m-t-10">
        {!! Form::label('str_client_tin', 'Taxpayer Identification Number', ['required'=>'required']) !!}
        {!! Form::text('str_client_tin', null, ['id' => 'str_client_tin', 'class' => 'form-control', ':value'=>'selected_client.str_client_tin']) !!}
    </div>
</div>