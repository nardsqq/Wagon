<div class="modal fade" id="add_disc" role="document">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header modal-header-success" id="discount-modal-header">
        <h4 class="modal-title"></h4>
      </div>
      <div class="modal-body">
        <form id="formVehiType">
          <div class="form-group">
            <label for="strVehiTypeName">Discount</label>
...
<div class="modal fade" id="del_disc">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header modal-header-danger" id="discount-del-modal-header">
