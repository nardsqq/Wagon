...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        if($request->ajax()) {
            ...
            $client->str_client_person = trim($request->str_client_person?:$request->contact_person);
            $client->str_client_mobile_num = trim($request->str_client_mobile_num?:$request->contact_no);
            $client->str_client_tel_num = trim($request->str_client_tel_num);
            $client->str_client_email = trim($request->str_client_email);
            $client->txt_client_address = trim($request->txt_client_address?:$request->billing_address);
