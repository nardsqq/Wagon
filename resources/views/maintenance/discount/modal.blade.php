      ...
      <div class="modal-body">
        <form id="formDisc">
          <div class="form-group">
            <label for="str_discount_name">Discount Name</label>
            <input type="text" id="str_discount_name" name="str_discount_name" class="form-control" required>
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
          </div>
          <div class="form-group">
            <label for="int_discount_percentage">Rate</label>
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-tag" aria-hidden="true"></i></span>
              <input type="number" class="form-control" name="int_discount_percentage" id="int_discount_percentage" required min="1">
