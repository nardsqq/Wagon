    ...
    $("#btn-save").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var row = "<tr id=id" + data.intDepartmentID +  ">"+
                "<td>" + data.strDepartmentName + "</td>" +
                "<td>" + data.strDesc + "</td>" +
                "<td class='text-center'><input type='checkbox' id='isActive' value=" + data.intDepartmentID + " name='isActive' "+checkstate+" data-toggle='toggle' data-style='android' data-onstyle='success' data-offstyle='default' data-on=\"<i class='fa fa-thumbs-o-up'></i> Active\" data-off=\"<i class='fa fa-thumbs-o-down'></i> Inactive\" data-size='mini'></td>"+
                ...
                if (state == "add"){ //if user added a new record
                    ...
                    $("#id"+data.intDepartmentID).replaceWith(row);
                }
