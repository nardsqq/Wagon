...
<div class="panel-group" id="accordion">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <a href="{{ url('/admin/maintenance/productinventory') }}" class="list-group-item active main-color-bg"><i class="fa fa-cubes fa-fw" aria-hidden="true"></i>&nbsp; Product Inventory</a>
    </div>
  </div>
