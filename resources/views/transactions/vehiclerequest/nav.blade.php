          ...
          <div class="list-group">
            <a href="{{ url('/admin/transactions/vehiclerequest') }}" class="list-group-item active main-color-bg"><i class="fa fa-car fa-fw" aria-hidden="true"></i>&nbsp; Create Vehicle Request</a>
