  ...
  <section id="breadcrumb">
    <div class="container animated fadeIn">
      <ol class="breadcrumb">
        <li>Admin</li>
        <li>Maintenance</li>
        <li class="breadcrumb-active">Product Inventory Status</li>
      </ol>
    </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="alert alert-success alert-white rounded">
            ...
            <strong>Manage <i>Product Inventory Status</i> here.</strong>
            <br>
          ...
          <div class="panel panel-default">
            <div class="panel-heading clearfix">
              <div class="btn-group pull-right">
                <button type="button" id="btn-add" class="btn btn-success"><i class="fa fa-plus-square"></i>&nbsp; Add Product Inventory Status</button>
              </div>
