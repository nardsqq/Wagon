      ...
      <div class="modal-body">
        {!! Form::open(['url' => '/admin/transactions/vehicle-request', 'method' => 'POST', 'id' => 'formVehiReq']) !!}
          ...
          <div class="form-group">
            ...
            {!! Form::date('datDeparture', \Carbon\Carbon::now()->format('Y-m-d'), array('id' => 'datDeparture', 'class' => 'form-control')); !!}
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
          </div>
          <div class="form-group">
            {!! Form::label('datEstReturn', 'Estimated Date of Return') !!}
            {!! Form::date('datEstReturn', \Carbon\Carbon::now()->format('Y-m-d'), array('id' => 'datEstReturn', 'class' => 'form-control')); !!}
          </div>
          <div class="form-group">
