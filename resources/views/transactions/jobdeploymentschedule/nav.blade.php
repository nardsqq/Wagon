          ...
          <div class="list-group">
            ...
            <a href="{{ url('/admin/transactions/quotation') }}" class="list-group-item"><i class="fa fa-quote-left fa-fw" aria-hidden="true"></i>&nbsp; Create Quotation</a>
            ...
            <a href="{{ url('/admin/transactions/jobdeploymentschedule') }}" class="list-group-item active main-color-bg"><i class="fa fa-calendar fa-fw" aria-hidden="true"></i>&nbsp; Set Job Deployment Schedule</a>
          </div>
