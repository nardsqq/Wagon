          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ url('/admin/maintenance/product') }}"><i class="fa fa-cart-plus fa-fw" aria-hidden="true"></i>&nbsp; Product</a></li>
                <li class="active"><a href="{{ url('/admin/maintenance/productinventorystatus') }}"><i class="fa fa-pie-chart fa-fw" aria-hidden="true"></i>&nbsp; Product Inventory Status</a></li>
