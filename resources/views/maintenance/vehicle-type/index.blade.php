...
@section('content')
 ...
 <header id="header">
  ...
  @include('maintenance.vehicle-type.modal')
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="alert alert-success alert-white rounded">
            ...
            <strong>Manage <i>Vehicle Types</i> here.</strong>
            <br>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div id="table-container">
                @include('maintenance.vehicle-type.table')
              </div>
            </div>
          </div>
        </div>
...
@section('scripts')
  ...
  <script src="{{ asset('/js/ajax/vehicle-type-ajax.js/') }}"></script>
