    ...
    $("#btn-save").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                "<td class='text-center'><input type='checkbox' id='isActive' value=" + data.intProductID + " name='isActive' "+checkstate+" data-toggle='toggle' data-style='android' data-onstyle='success' data-offstyle='default' data-on=\"<i class='fa fa-thumbs-o-up'></i> Active\" data-off=\"<i class='fa fa-thumbs-o-down'></i> Inactive\" data-size='mini'></td>"+
